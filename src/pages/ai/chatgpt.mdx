...
## Useful prompts
- Write a polite email and answer **no** to this email and sign with my name which is Andreas: text-here
- Write a polite email and answer **yes** to this email and sign with my name which is Andreas: text-here
